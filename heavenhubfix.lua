...
namenameToggle.Text = "Name: " .. (espSettings.name and "On" or "Off")end)local function createESP(player)
      ...
      if success then
        ...
        if espSettings.box then
            ...
            if success then
              ...
              box.Color = BrickColor.new(Color3.fromRGB(0, 255, 0))
  ...
  endendfor _, player in pairs(game.Players:GetPlayers()) do
...
game.Players.PlayerAdded:Connect(function(player)
  ...
  endend)local uis = game:GetService("UserInputService")
